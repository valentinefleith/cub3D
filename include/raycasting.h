...
t_vector	get_closest_point(t_vector target, t_vector a, t_vector b, bool *orientation);
...
// t_vector	get_point_vert(t_maze *maze, t_map *map, double angle, t_dir direction, t_vector point);//proto to debug
